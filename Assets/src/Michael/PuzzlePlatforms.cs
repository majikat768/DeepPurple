...
public class PuzzlePlatforms : PuzzleRoom {
    ...
    private void BuildPlatforms() {
        ...
        p8.transform.position = new Vector3(Zero.x+size.x/2,p7.transform.position.y,p7.transform.position.z);
        p8.AddComponent<MovingPlatform>().Init(p8.transform.position, p8.transform.position + new Vector3(0, 3, 0),1,true);
